...
const EN = {
  ...
  signedConsentCopies: 'Signed Consent Copies', captureConsentCopies: 'Photograph both signed consent forms separately. Capture C1 and C2 in full, including the signature or thumb impression.',
  c1ConsentCopy: 'C1 Signed Consent Form', c2ConsentCopy: 'C2 Signed Consent Form', captureC1Copy: 'Capture C1 copy', captureC2Copy: 'Capture C2 copy',
  consentCopyHint: 'Place the form on a flat surface, keep all four corners inside the guide, and make sure the signature or thumb impression is clearly visible.',
  bothConsentCopiesCaptured: 'Signed C1 and C2 consent copies captured.', proceedSubmit: 'Proceed to submit',
  ...
  previous: 'Previous', next: 'Next', reviewAnswers: 'Review answers', answer: 'Answer', response: 'Response',
  typeResponse: 'Type the response…', rateStatements: 'Rate each statement',
...
const HI = {
  ...
  signedConsentCopies: 'हस्ताक्षरित सहमति प्रतियाँ', captureConsentCopies: 'दोनों हस्ताक्षरित सहमति प्रपत्रों की अलग-अलग फोटो लें। C1 और C2 को हस्ताक्षर या अंगूठे के निशान सहित पूरा कैप्चर करें।',
  c1ConsentCopy: 'C1 हस्ताक्षरित सहमति प्रपत्र', c2ConsentCopy: 'C2 हस्ताक्षरित सहमति प्रपत्र', captureC1Copy: 'C1 प्रति की फोटो लें', captureC2Copy: 'C2 प्रति की फोटो लें',
  consentCopyHint: 'प्रपत्र को समतल सतह पर रखें, चारों कोने गाइड के अंदर रखें और हस्ताक्षर या अंगूठे का निशान साफ़ दिखाई देना सुनिश्चित करें।',
  bothConsentCopiesCaptured: 'C1 और C2 की हस्ताक्षरित सहमति प्रतियों की फोटो ले ली गई है।', proceedSubmit: 'जमा करने के लिए आगे बढ़ें',
  ...
  answer: 'उत्तर', response: 'प्रतिक्रिया',
...
const TA = {
  ...
  signedConsentCopies: 'கையொப்பமிட்ட ஒப்புதல் நகல்கள்', captureConsentCopies: 'கையொப்பமிட்ட இரண்டு ஒப்புதல் படிவங்களையும் தனித்தனியாகப் படம் எடுக்கவும். கையொப்பம் அல்லது பெருவிரல் ரேகையுடன் C1 மற்றும் C2 முழுவதும் தெரிய வேண்டும்.',
  c1ConsentCopy: 'C1 கையொப்பமிட்ட ஒப்புதல் படிவம்', c2ConsentCopy: 'C2 கையொப்பமிட்ட ஒப்புதல் படிவம்', captureC1Copy: 'C1 நகலைப் படம் எடு', captureC2Copy: 'C2 நகலைப் படம் எடு',
  consentCopyHint: 'படிவத்தைத் தட்டையான மேற்பரப்பில் வைத்து, நான்கு மூலைகளும் வழிகாட்டிக்குள் இருப்பதையும் கையொப்பம் அல்லது பெருவிரல் ரேகை தெளிவாகத் தெரிவதையும் உறுதிப்படுத்தவும்.',
  bothConsentCopiesCaptured: 'C1 மற்றும் C2 கையொப்பமிட்ட ஒப்புதல் நகல்கள் படம் எடுக்கப்பட்டன.', proceedSubmit: 'சமர்ப்பிக்கச் செல்லவும்',
  ...
  previous: 'முந்தையது', next: 'அடுத்தது', reviewAnswers: 'பதில்களைச் சரிபார்', answer: 'பதில்', response: 'பதில்',
  typeResponse: 'பதிலை எழுதவும்…', rateStatements: 'இரு கூற்றுகளுக்கும் பதிலளிக்கவும்',
